...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('registration_codes', function (Blueprint $table) {
            ...
            // Offline payment — FK added after offline_payments table is created
            // See migration: 2026_01_01_000012_add_offline_payment_foreign_key.php
            $table->unsignedBigInteger('offline_payment_id')->nullable()
                ->comment('FK to offline_payments. Constraint added in a later migration.');
